...
def main():
    ...
    g = lineplot(np.array(qd_score), np.arange(1, len(qd_score)+1, 1), color='green', xlabel='Iteration', ylabel='QD Score', title="Architext with prompt-based mutation - QD Score", fontsize=20, ymax=150, xmax=10, save_file='QDScore_architext_entropy-typology_hlff.png')
