...
def main():
    ...
    g = lineplot(np.array(qd_score), np.arange(1, len(qd_score)+1, 1), color='green', xlabel='Iteration', ylabel='QD Score', title="QD Score across iterations", fontsize=20, ymax=100, xmax=100, save_file='QDScore_architext_entropy-typology_hlff.png')
