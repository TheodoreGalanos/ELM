...
def main():
    ...
    g = lineplot(qd_score, np.arange(1, iterations+1, 1), color='green', xlabel='Iteration', ylabel='QD Score', title="QD Score", fontsize=20, ymax=100, xmax=100, save_file='QDScore_architext_entropy-typology_hlff.png')
